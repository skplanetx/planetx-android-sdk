...
public class TcloudImageTags extends BaseActivity implements OnClickListener {
	...
	// Comm Data
	String URL = Const.SERVER + "/tcloud/image/tags";
	...
	public void initRequestBundle()
	{
		...
		String payload = "{\"tag\":{\"name\":\"New Tag Here\"}}";
