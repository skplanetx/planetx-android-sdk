...
public class ElevenStreetCategories extends BaseActivity implements OnClickListener {
	...
	// Comm Data
	String URL = Const.SERVER_PUBLIC + "/11st/common/categories";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.elevenstreetcategories);
