...
public class NateOnGetProfile extends BaseActivity implements OnClickListener {
	...
	// Comm Data
	String URL = Const.SERVER + "/nateon/profile";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nateongetprofile);
