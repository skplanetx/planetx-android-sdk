...
public class NateOnModProfile extends BaseActivity implements OnClickListener {
	...
	// Comm Data
	String URL = Const.SERVER + "/nateon/profile/nickname";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.nateonmodprofile);
	...
	public void initUI() {
		...
		etInput = (EditText) findViewById(R.id.DETAIL_ET_INPUT);
	}
	...
	public void initRequestBundle()
	{
		...
		param.put("version", "1");
		param.put("nickname", etInput.getText()+"");
